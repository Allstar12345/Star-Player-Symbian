...
Component {
    ...
    Item {
        ...
        MouseArea{anchors.fill: parent; onClicked:{console.log(filePath);audio.source= "file:///"+ filePath; QMLUtils.minimizeApp();startui.visible= false;creator.createComponent("BackgroundPlayerUI.qml"); backgroundplay.start();QMLUtils.showPopup("Star Player", "CPU Will Be Under High Load!")}}
        width:parent.width
        height: 100
                Image {
                    id: img
